...
void loop()
{
  //The following code will allow us to change the file name displayed on the screen for testing by simply writing to the serial buffer with the name. 
  //Send the string of the file name to the arduino
  //It will compare it to the file names on the SD card and select it. 
  //If the file isn't available, it will return an error message saying the file isn't available. 
  ...
  */
  ...
  drawBMP("csattest.bmp", 0, 0, BU_BMP);
  delay(1000);
  //display test image 
}
